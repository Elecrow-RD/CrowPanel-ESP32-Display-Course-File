...
// BluetoothSerial entity
BluetoothSerial SerialBT;
 
// ESP32 Bluetooth slave info
const char *pin = "1234"; // change it follow your 
String device_name = "ESP32-BT-Slave"; // Master will connect the slave according to this device name.
